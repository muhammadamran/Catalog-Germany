	...
	<div class="container">	
		...
		<div class="row">
			<table>
				...
				<tbody>
				<?php
				$query = mysqli_query($con,"SELECT a.id AS kitkat,a.id_transaksi,a.id_user,a.kode_transaksi,a.alamat,a.kodepos,
											b.kode_transaksi,b.id_produk,b.jumlah,b.size,b.harga,b.catatan,b.status,b.date_add,
											c.id_user,c.nama_depan,c.nama_belakang,
											d.id,d.nama_produk,d.harga,d.diskon
											FROM tbl_transaksi a
											JOIN tbl_keranjang b 
											...
											JOIN tbl_produk d 
											ON b.id_produk=d.id 
											WHERE a.id_user='$sesi_ker' AND a.id=".$_GET['id']."");
