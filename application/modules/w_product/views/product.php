                        ...
                        <div class="col-lg-6 col-12">
                            <form action="<?= base_url('w_product/keranjang');?>" method="post">
                                <div class="product__info__main">
                                    ...
                                    <div class="subtotal">
                                        <!-- HARGA TOTAL JUMLAH -->
                                        <h5>Sub Total </h5><h3>Rp. <b><input class="nilai-subtotal" name="harga" type="text" name="total_jumlah" id="totalkeroncange" size="7" value="" readonly></b></h3>
                                        ...
                                        <div class="review_form_field">
                                            <!-- <span><b><img src="<?= base_url('mode/images/icons/notes.png'); ?>"> <font style="font-family: 'Poppins', sans-serif; color:#ea6024">Catatan Jika Ada</font></b> <small><i>(Optional)</i></small></span> -->
                                            <span><b><img src="<?= base_url('mode/images/icons/notes.png'); ?>"> <font style="font-family: 'Poppins', sans-serif; color:#ea6024">Catatan Pemesanan</font></b></span>
